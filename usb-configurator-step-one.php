...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Konfigurator USB - Personalizacja pendrive’a</title>
    ...
    <body>
        ...
        <main id="main-wrapper" class="grey-background">
            ...
            <?php include "./components/usb_configurator/usb_config_main_wrapper_step_one.php"; ?> 
        </main>
        <footer> 
        ...
        <script src="./js/usb_checked_colors.js"></script>
    </body>
</html>