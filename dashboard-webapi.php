...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Panel Klienta - WebAPI</title>
    ...
    <body>
        ...
        <main id="main-wrapper">
            <div class="dashboard-container container">
                ...
                <div class="dashboard-container__right">
                    ...
                    <?php include "./components/dashboard/dashboard_webapi_content.php"; ?> 
                </div>
            </div>
        </main>
        <footer> 
        ...
        <script>
            document.querySelector('.menu-links-box.big-web-api > a:nth-of-type(1)').classList.add('active');
        </script>
