...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Panel Klienta - Zamówienia</title>
    ...
    <body>
        ...
        <main id="main-wrapper">
            <div class="dashboard-container container">
                ...
                <div class="dashboard-container__right">
                    ...
                    <?php include "./components/dashboard/dashboard_orders_content.php"; ?> 
                </div>
            </div>
        </main>
        <footer> 
        ...
        <script>
            document.querySelector('.menu-links-box.big-orders > a:nth-of-type(2)').classList.add('active');
        </script>
