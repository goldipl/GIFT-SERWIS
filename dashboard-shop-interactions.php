...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Panel Klienta - Interakcje klientów z Twoją stroną noname</title>
    ...
    <body>
        ...
        <main id="main-wrapper">
            <div class="dashboard-container container">
                ...
                <div class="dashboard-container__right">
                    ...
                    <?php include "./components/dashboard/dashboard_shop_interactions_content.php"; ?> 
                </div>
            </div>
        </main>
        <footer> 
        ...
        <script>
            document.querySelector('.menu-links-box.big-no-name-shop > a:nth-of-type(2)').classList.add('active');
        </script>
