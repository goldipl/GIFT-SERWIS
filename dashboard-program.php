...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Panel Klienta - Program Rozwoju</title>
    ...
    <body>
        ...
        <main id="main-wrapper">
            <div class="dashboard-container container">
                ...
                <div class="dashboard-container__right">
                    ...
                    <?php include "./components/dashboard/dashboard_program_content.php"; ?> 
                </div>
            </div>
        </main>
        <footer> 
        ...
        <script>
            document.querySelector('.menu-links-box.big-profile > a:nth-of-type(5)').classList.add('active');
        </script>
