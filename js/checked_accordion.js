document.addEventListener("DOMContentLoaded", function () {
    ...
    const orangeBtnColors = document.querySelector('#collapse12 button.white-btn');
    ...
    // Get the button element
    const orangeBtnQuantity = document.querySelector('#collapse13 button.white-btn');
    ...
    // Get the button element
    const orangeBtnBranding = document.querySelector('#collapse14 button.white-btn');
