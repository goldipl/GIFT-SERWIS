...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Kreator sklepów i katalogów online - Finalizacja</title>
            ...
            <div class="shop-creator-wrapper container">
                ...
                <div class="common-steps-container">
                    <div class="container">
                        ...
                        <div class="common-steps-container-slot">
                            <p class="active">7. Finalizacja</p>
                        </div>
                    </div>
                </div> 
                <?php include "./components/shop_creator/shop_creator_step_seven_content.php"; ?>
            </div>
        </main>
        <footer> 
