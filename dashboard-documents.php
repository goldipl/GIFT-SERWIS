...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Panel Klienta - Dokumenty</title>
    ...
    <body>
        ...
        <main id="main-wrapper">
            <div class="dashboard-container container">
                ...
                <div class="dashboard-container__right">
                    ...
                    <?php include "./components/dashboard/dashboard_download_documents_content.php"; ?> 
                </div>
            </div>
        </main>
        <footer> 
        ...
        <script>
            document.querySelector('.menu-links-box.big-to-download > a:nth-of-type(7)').classList.add('active');
        </script>
