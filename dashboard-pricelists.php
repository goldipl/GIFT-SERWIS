...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Panel Klienta - Cenniki</title>
    ...
    <body>
        ...
        <main id="main-wrapper">
            <div class="dashboard-container container">
                ...
                <div class="dashboard-container__right">
                    ...
                    <?php include "./components/dashboard/dashboard_pricelists_content.php"; ?> 
                </div>
            </div>
        </main>
        <footer> 
        ...
        <script>
            document.querySelector('.menu-links-box.big-to-download > a:nth-of-type(3)').classList.add('active');
        </script>
