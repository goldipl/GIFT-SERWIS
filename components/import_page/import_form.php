<form class="import_form">
    <div class="container">
        <h2 class="import-form-title">
            <strong>Wypełnij</strong> formularz
        </h2>
        <div class="title">
        ...
        <button class="white-pink-btn">Wyślij <img src="./assets/icons/common/buttons/button_pink_arrow.svg" alt="arrow icon" width="18" height="18">
        </button>
    </div>
</form>