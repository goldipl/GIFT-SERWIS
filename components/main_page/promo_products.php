<section id="promo_products_container">
  ...
  <div class="main-check-btn-box">
    <a href="./category.php" class="white-purple-btn">Sprawdź wszystkie <img src="./assets/icons/common/buttons/button_color_arrow.svg" alt="arrow icon" width="18" height="18">
    </a>
  </div>
</section>