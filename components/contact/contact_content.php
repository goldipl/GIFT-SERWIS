<div class="contact-container container">
  <form class="send-form-box">
    <h2>Napisz do Nas</h2>
    <span class="d-flex mb-2">Zapytanie:</span>
    <div class="input-slot">
      <p>
        <a class="ask-product-link" href="">
          <strong>Długopis metalowy (1363944)</strong>
        </a>
      </p>
      <a class="ask-product-link" href="">
        <img src="./assets/img/product_card/product-card-01.jpg" height="200">
      </a>
    </div>
    <div class="send-form">
