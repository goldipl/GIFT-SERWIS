<form class="shopcreator-content container">
  ...
  <div class="textbox">
    <p>pod którą będzie widoczny Twój sklep. Nie używaj polskich znaków. Maksymalna długość subdomeny: <strong>20</strong> znaków. </p>
    <p>Subdomena to tylko fragment pełnego adresu strony - zobacz przykład poniżej. Przykładowa subdomena wyróżniona jest kolorem różowym.</p>
  </div>
  <div class="greybox">
  ...
  <div class="bottom-button right-btn justify-content-end">
