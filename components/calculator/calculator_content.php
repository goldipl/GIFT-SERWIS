                ...
                <div class="colors-col">
                  <div class="colors-info-box">
                    <div class="mix-container">
                      <img src="./assets/icons/calculator/colors-mix.svg" alt="colors mix icon" width="32" height="32">
          ...
          <div class="accordion-item" id="step-four">
            <h2 class="accordion-header" id="heading14">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                <span class="number">4</span>Kliknij i wybierz technikę oraz miejsce znakowania <img src="./assets/icons/common/check-circle-fill.svg" alt="check-circle icon" width="24" height="24">
              </button>
            </h2>
            ...
            <div id="collapse15" class="accordion-collapse collapse" aria-labelledby="heading15" data-bs-parent="#accordionExample">
              <div class="accordion-body">
                <div class="pricing-box">
                  ...
                  <div class="pricing-box__info-box">
                    <p>Przekroczyłeś kwotę kalkulacji <span class="pink">1000,00 PLN</span> i otrzymujesz kod rabatowy <span class="green-big">DOBRYSTART3</span> dający rabat <span class="green-small">3%</span> na cały koszyk. Kliknij kod by skopiować go do schowka.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="tables-box">
                  <table>
                    <tbody>
                      ...
                      <tr>
                        <td>Cena katalogowa netto (1 szt.)</td>
                        <td>1,99 PLN</td>
                        <td>Rabat:</td>
                        <td>44%</td>
                      </tr>
                      <tr>
                        <td>Twoja cena netto (1 szt.):</td>
                        <td>1,09 PLN</td>
                        <td>Wartość produktów netto (100 szt.):</td>
                        <td>109,00 PLN</td>
                      </tr>
                    </tbody>
                  </table>
                  <table>
                    <tbody>
                      <tr>
                        <th colspan="2">Znakowanie LOGOTYP A</th>
                        <th colspan="2">Znakowanie LOGOTYP B</th>
                      </tr>
                      <tr>
                        <td>L0 grawer laserowy (1 szt.)</td>
                        <td>0,29 PLN</td>
                        <td>S2 sitodruk (1 szt.)</td>
                        <td>0,29 PLN</td>
                      </tr>
                      <tr>
                        <td>Liczba miejsc:</td>
                      ...
                      <tr>
                        <td>Liczba kolorów:</td>
                        <td>1</td>
                        <td>Liczba kolorów:</td>
                        <td>4</td>
                      </tr>
                      <tr>
                        <td>Koszt pakowania (1 szt.):</td>
                        <td>0,10 PLN</td>
                        <td>Koszt pakowania (1 szt.):</td>
                        <td>GRATIS!</td>
                      </tr>
                      <tr>
                        <td>Koszt przygotowania (1 szt.):</td>
                        <td>0,20 PLN</td>
                        <td>Koszt przygotowania (1 szt.):</td>
                        <td>0,20 PLN</td>
                      </tr>
                      <tr>
                        <td>Całkowity koszt znakowania (1 szt.):</td>
                        <td>0,59 PLN</td>
                        <td>Całkowity koszt znakowania (1 szt.):</td>
                        <td>7,32 PLN</td>
                      </tr>
                      <tr>
                        <td>Całkowity koszt znakowania (100 szt.):</td>
                        <td>59,00 PLN</td>
                        <td>Całkowity koszt znakowania (100 szt.):</td>
                        <td>732,00 PLN</td>
                      </tr>
