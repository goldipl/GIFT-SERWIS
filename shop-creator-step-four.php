...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Kreator sklepów i katalogów online - Ceny</title>
        ...
        <main>
            ...
            <div class="shop-creator-wrapper container">
                ...
                <div class="progress common-progress-bar">
                    <div class="progress-bar" role="progressbar" aria-label="Basic example" style="width: 56.8%" aria-valuenow="56.8" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                ...
                <?php include "./components/shop_creator/shop_creator_step_four_content.php"; ?>
            </div>
        </main>
        <footer> 
