...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Kreator sklepów i katalogów online - Sklep</title>
    ...
    <body>
        ...
        <main>
            ...
            <div class="shop-creator-wrapper container">
                ...
                <?php include "./components/shop_creator/shop_creator_step_two_content.php"; ?>
            </div>
        </main>
        <footer> 
