...
<html lang="pl">
    <head>
        ...
        <title>GiftSerwis - Kreator sklepów i katalogów online - Adres</title>
        ...
        <main>
            ...
            <div class="shop-creator-wrapper container">
                ...
                <div class="progress common-progress-bar">
                    <div class="progress-bar" role="progressbar" aria-label="Basic example" style="width: 14.3%" aria-valuenow="14.3" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="common-steps-container">
                    <div class="container">
                        <div class="common-steps-container-slot">
                            <p class="active">1. Adres</p>
                        </div>
                        <div class="common-steps-container-slot">
                            <p>2. Sklep</p>
                        </div>
                ...
                <?php include "./components/shop_creator/shop_creator_step_one_content.php"; ?>
            </div>
        </main>
        <footer> 
